...
(function(window) {
    ...
    function instantiateArrayBuffer(binaryFile, imports, receiver) {
        return getBinaryPromise(binaryFile).then(binary => {
            const a = new Uint8Array(binary, 0, 19889);
            const aa = new Uint8Array([0x20, 0x00, 0x28, 0x02, 0x1c, 0x45, 0x04, 0x40, 0x0f, 0x0b]);
            const aaa = new Uint8Array(binary, 19889);
    ...
    var _ac_connect = Module["_ac_connect"] = function() {
        return (_ac_connect = Module["_ac_connect"] = Module["asm"]["s"]).apply(null, arguments)
    };
    var _ac_set_player_name = Module["_ac_set_player_name"] = function() {
        return (_ac_set_player_name = Module["_ac_set_player_name"] = Module["asm"]["t"]).apply(null, arguments)
    };
    var _ac_load_skin = Module["_ac_load_skin"] = function() {
        return (_ac_load_skin = Module["_ac_load_skin"] = Module["asm"]["u"]).apply(null, arguments)
    };
    var _ac_set_mouse_position = Module["_ac_set_mouse_position"] = function() {
        return (_ac_set_mouse_position = Module["_ac_set_mouse_position"] = Module["asm"]["v"]).apply(null, arguments)
    };
    var _ac_split = Module["_ac_split"] = function() {
        return (_ac_split = Module["_ac_split"] = Module["asm"]["w"]).apply(null, arguments)
    };
    var _ac_eject = Module["_ac_eject"] = function() {
        return (_ac_eject = Module["_ac_eject"] = Module["asm"]["x"]).apply(null, arguments)
    };
    var _ac_special_on = Module["_ac_special_on"] = function() {
        return (_ac_special_on = Module["_ac_special_on"] = Module["asm"]["y"]).apply(null, arguments)
    };
    var _ac_special_off = Module["_ac_special_off"] = function() {
        return (_ac_special_off = Module["_ac_special_off"] = Module["asm"]["z"]).apply(null, arguments)
    };
    var _ac_zoom = Module["_ac_zoom"] = function() {
        return (_ac_zoom = Module["_ac_zoom"] = Module["asm"]["A"]).apply(null, arguments)
    };
    var _ac_spectate = Module["_ac_spectate"] = function() {
        return (_ac_spectate = Module["_ac_spectate"] = Module["asm"]["B"]).apply(null, arguments)
    };
    var _ac_disconnect = Module["_ac_disconnect"] = function() {
        return (_ac_disconnect = Module["_ac_disconnect"] = Module["asm"]["C"]).apply(null, arguments)
    };
    var _ac_proxy_mobile_data = Module["_ac_proxy_mobile_data"] = function() {
        return (_ac_proxy_mobile_data = Module["_ac_proxy_mobile_data"] = Module["asm"]["D"]).apply(null, arguments)
    };
    var _ac_every_second = Module["_ac_every_second"] = function() {
        return (_ac_every_second = Module["_ac_every_second"] = Module["asm"]["E"]).apply(null, arguments)
    };
    var _ac_send_facebook_data = Module["_ac_send_facebook_data"] = function() {
        return (_ac_send_facebook_data = Module["_ac_send_facebook_data"] = Module["asm"]["F"]).apply(null, arguments)
    };
    var _ac_set_integrity_checks = Module["_ac_set_integrity_checks"] = function() {
        return (_ac_set_integrity_checks = Module["_ac_set_integrity_checks"] = Module["asm"]["G"]).apply(null, arguments)
    };
    var _ac_set_quality = Module["_ac_set_quality"] = function() {
        return (_ac_set_quality = Module["_ac_set_quality"] = Module["asm"]["H"]).apply(null, arguments)
    };
    var _ac_set_fps_cap = Module["_ac_set_fps_cap"] = function() {
        return (_ac_set_fps_cap = Module["_ac_set_fps_cap"] = Module["asm"]["I"]).apply(null, arguments)
    };
    var _ac_get_game_state = Module["_ac_get_game_state"] = function() {
        return (_ac_get_game_state = Module["_ac_get_game_state"] = Module["asm"]["J"]).apply(null, arguments)
    };
    var _ac_get_for_crazy_games = Module["_ac_get_for_crazy_games"] = function() {
        return (_ac_get_for_crazy_games = Module["_ac_get_for_crazy_games"] = Module["asm"]["K"]).apply(null, arguments)
    };
    var _ac_cancel_enter_arena = Module["_ac_cancel_enter_arena"] = function() {
        return (_ac_cancel_enter_arena = Module["_ac_cancel_enter_arena"] = Module["asm"]["L"]).apply(null, arguments)
    };
    var _ac_player_has_cells = Module["_ac_player_has_cells"] = function() {
        return (_ac_player_has_cells = Module["_ac_player_has_cells"] = Module["asm"]["M"]).apply(null, arguments)
    };
    var _cp5_idle = Module["_cp5_idle"] = function() {
        return (_cp5_idle = Module["_cp5_idle"] = Module["asm"]["N"]).apply(null, arguments)
    };
    var _ac_set_fadeout = Module["_ac_set_fadeout"] = function() {
        return (_ac_set_fadeout = Module["_ac_set_fadeout"] = Module["asm"]["O"]).apply(null, arguments)
    };
    var _ac_register_game_play_setting = Module["_ac_register_game_play_setting"] = function() {
        return (_ac_register_game_play_setting = Module["_ac_register_game_play_setting"] = Module["asm"]["P"]).apply(null, arguments)
    };
    var _ac_set_show_mass = Module["_ac_set_show_mass"] = function() {
        return (_ac_set_show_mass = Module["_ac_set_show_mass"] = Module["asm"]["Q"]).apply(null, arguments)
    };
    var _ac_set_show_quest = Module["_ac_set_show_quest"] = function() {
        return (_ac_set_show_quest = Module["_ac_set_show_quest"] = Module["asm"]["R"]).apply(null, arguments)
    };
    var _ac_set_black_theme = Module["_ac_set_black_theme"] = function() {
        return (_ac_set_black_theme = Module["_ac_set_black_theme"] = Module["asm"]["S"]).apply(null, arguments)
    };
    var _ac_set_names_enabled = Module["_ac_set_names_enabled"] = function() {
        return (_ac_set_names_enabled = Module["_ac_set_names_enabled"] = Module["asm"]["T"]).apply(null, arguments)
    };
    var _ac_set_no_colors = Module["_ac_set_no_colors"] = function() {
        return (_ac_set_no_colors = Module["_ac_set_no_colors"] = Module["asm"]["U"]).apply(null, arguments)
    };
    var _ac_set_skins_enabled = Module["_ac_set_skins_enabled"] = function() {
        return (_ac_set_skins_enabled = Module["_ac_set_skins_enabled"] = Module["asm"]["V"]).apply(null, arguments)
    };
    var _ac_set_acid = Module["_ac_set_acid"] = function() {
        return (_ac_set_acid = Module["_ac_set_acid"] = Module["asm"]["W"]).apply(null, arguments)
    };
    var _ac_set_show_online_status = Module["_ac_set_show_online_status"] = function() {
        return (_ac_set_show_online_status = Module["_ac_set_show_online_status"] = Module["asm"]["X"]).apply(null, arguments)
    };
    var _ac_set_show_minimap = Module["_ac_set_show_minimap"] = function() {
        return (_ac_set_show_minimap = Module["_ac_set_show_minimap"] = Module["asm"]["Y"]).apply(null, arguments)
    };
    var _ac_set_minimize_minimap = Module["_ac_set_minimize_minimap"] = function() {
        return (_ac_set_minimize_minimap = Module["_ac_set_minimize_minimap"] = Module["asm"]["Z"]).apply(null, arguments)
    };
    var _ac_set_players_minimap = Module["_ac_set_players_minimap"] = function() {
        return (_ac_set_players_minimap = Module["_ac_set_players_minimap"] = Module["asm"]["_"]).apply(null, arguments)
    };
    var _cp5_check_ws = Module["_cp5_check_ws"] = function() {
        return (_cp5_check_ws = Module["_cp5_check_ws"] = Module["asm"]["$"]).apply(null, arguments)
    };
    var _ac_register_skin = Module["_ac_register_skin"] = function() {
        return (_ac_register_skin = Module["_ac_register_skin"] = Module["asm"]["aa"]).apply(null, arguments)
    };
    var _ac_register_animated_skin = Module["_ac_register_animated_skin"] = function() {
        return (_ac_register_animated_skin = Module["_ac_register_animated_skin"] = Module["asm"]["ba"]).apply(null, arguments)
    };
    var _ac_show_animations = Module["_ac_show_animations"] = function() {
        return (_ac_show_animations = Module["_ac_show_animations"] = Module["asm"]["ca"]).apply(null, arguments)
    };
